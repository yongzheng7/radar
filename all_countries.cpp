...
QMap< QString, QString > Countries::allCountries()
{
    static QMap< QString, QString > countries{
        ...
        {QStringLiteral("Korea (Democratic People's Republic of)"), QStringLiteral("KP")},
        {QStringLiteral("Korea, Republic of"), QStringLiteral("KR")},
        ...
        {QStringLiteral("Micronesia (Federated States of)"), QStringLiteral("FM")},
        ...
        {QStringLiteral("United Kingdom of Great Britain and Northern Ireland"), QStringLiteral("GB")},
